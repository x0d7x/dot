...
description: Analyzes requirements and codebase, generates context and meta-prompt handoff material
...
- stop/escalation rules: when to ask, when enough evidence is enough, and when to stop
